...
holds the lock (marked by BB_GATE_LOCK_HELD) runs the command directly.
The variables start with BB_, not BUILDBANNER_, because BUILDBANNER_*
variables configure the product.
"""
...
LOCK_ENV = "BB_GATE_LOCK"
HELD_ENV = "BB_GATE_LOCK_HELD"
LOCK_NAME = "buildbanner-gate.lock"
EXIT_LOCK_FAILED = 97


def lock_path() -> Path:
    """Return the lock file path: $BB_GATE_LOCK, else $TMPDIR/<LOCK_NAME>."""
